...
$$
\bZ_i \, | \, \bX_i \sim \mathcal{N}\left(\bS^{-1} \hat{\bC}^\top (\bX_i - \bar{\bx}), \bS^{-1} \hat{\sigma}^2  \right), \quad \bS = \left(\hat{\bC}^\top \hat{\bC} + \hat{\sigma}^2\right)
$$
...
#### Variational approximation \scriptsize  [@WaJ08, @blei2017variational]
